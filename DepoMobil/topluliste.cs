...
{
    /// <summary>
    /// Summary description for topluliste.
    /// </summary>
    public class topluliste : System.Windows.Forms.Form
    {
        ...
        public topluliste(string tabload, Int64 irsaliyeno)
        {
        ...
        private void toplulistegetir()
        {
            ...
            string sql = " select distinct sicil_adi,sum(Miktar) as miktar from " + tabload + "detay where siparis_no = " + irsaliyeno + " group by sicil_Adi";
